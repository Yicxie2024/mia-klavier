...
export default function YichenAbout() {
  return (
    <Box
      w={LAYOUT.FULL_WIDTH}
      ...
      bgColor="gray.200"
    >
      <HStack data-component="YichenAbout-Stack" justifyContent="left" alignItems="flex-start">
        <YichenNavigation />
        <Box width={LAYOUT.CONTENT_WIDTH} marginTop={LAYOUT.NAVIGATION_MARGIN_TOP}>
          ...
          <Text fontSize="lg" color="gray.600">
            About Yichen's NLP Lab content will be displayed here.
          </Text>
        </Box>
      </HStack>
    </Box>
